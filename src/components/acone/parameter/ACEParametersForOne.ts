...
export default class ACEParametersForOne extends ACEParameters {
  ...
  public getInstallReferrer(
    ...
    if (!global.Promise) {
      ...
      const result = localStorage.getItem(ACECONSTANT.InstallReferrer)
      ACELog.d(ACEParametersForOne._TAG, `${ACECONSTANT.InstallReferrer}: ${result}`)
      if (callback) {
        callback(result == null ? new Error('localStorage.getItem(ACECONSTANT.InstallReferrer)') : undefined, {
          getKey: ACECONSTANT.InstallReferrer,
          getValue: result == null ? undefined : result,
        })
      }
    } else {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (callback) {
          ...
          if (result == null) {
            reject(new Error('localStorage.getItem(ACECONSTANT.InstallReferrer)'))
          } else {
            resolve({
              getKey: ACECONSTANT.InstallReferrer,
              getValue: result == null ? undefined : result,
  ...
  public setInstallReferrer(
    ...
    if (!global.Promise) {
      ...
      try {
        localStorage.setItem(ACECONSTANT.InstallReferrer, value)
        if (callback) {
          callback(undefined, {
            getKey: ACECONSTANT.InstallReferrer,
            getValue: value,
  ...
  public loadST(callback?: ((error?: Error, result?: object) => void) | undefined): Promise<object> | void {
    if (!global.Promise) {
      ...
      const result = localStorage.getItem(ACOneConstantSt.KeyInStorage)
      ACELog.d(ACEParametersForOne._TAG, 'in loadST::in cb::result', JSON.parse(result ?? '{"result":"undefined"}'))
      if (callback) {
        if (result == null) {
          callback(undefined, {
  ...
  public saveST_toInStorage(
    ...
    if (!global.Promise) {
      try {
        localStorage.setItem(ACOneConstantSt.KeyInStorage, _json)
        if (callback) {
          callback(undefined, {
  ...
  public loadVT(callback?: ((error?: Error, result?: object) => void) | undefined): Promise<object> | void {
    if (!global.Promise) {
      const result = localStorage.getItem(ACOneConstantVt.KeyInStorage)
  ...
  public saveVT_toInStorage(
    ...
    if (!global.Promise) {
      try {
        localStorage.setItem(ACOneConstantVt.KeyInStorage, _json)
        if (callback) {
          callback(undefined, {
